...
/* ********************************************************************************
 * This program was based off the interrupt example provided by Altera and modified by
 * Matt Hartnett. This program utilizes the interrupts generated by the interval
 * timer to show a clock display on the seven segments of the DE1-SoC board.
 *
 * The modifications are as follows:
 *      Altered this file to change the frequency of interrupt generation - occurs
 *      every 0.01 seconds
 *      Altered interval_timer_ISR.c to change the functionality of the device when
 *      interval timers are recieved. It now incrememts a timer variable set and
 *      displays the timer to the seven segment displays using the HEX_DISP function.
 *
 *
