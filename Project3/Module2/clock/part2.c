...
volatile int hex0 = 0x0; // pattern for HEX display 0
volatile int hex1 = 0x0; // pattern for HEX display 1
volatile int hex2 = 0x0; // pattern for HEX display 2
volatile int hex3 = 0x0; // pattern for HEX display 3
volatile int hex4 = 0x0; // pattern for HEX display 4
volatile int hex5 = 0x0; // pattern for HEX display 5
