...
volatile int hex1 = 0x1; // pattern for HEX display 1
volatile int hex2 = 0x2; // pattern for HEX display 2
volatile int hex3 = 0x3; // pattern for HEX display 3
volatile int hex4 = 0x4; // pattern for HEX display 4
volatile int hex5 = 0x5; // pattern for HEX display 5
